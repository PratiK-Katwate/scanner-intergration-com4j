...
public interface IProperty extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type wia.WiaSubType
   */

  @DISPID(6) //= 0x6. The runtime will prefer the VTID if present
  @VTID(15)
  wia.WiaSubType subType();
   ...
   * </p>
   * @return  Returns a value of type wia.IVector
   */

  @DISPID(8) //= 0x8. The runtime will prefer the VTID if present
  @VTID(17)
  wia.IVector subTypeValues();


  @VTID(17)
  @ReturnValue(type=NativeType.VARIANT,defaultPropertyThrough={wia.IVector.class})
