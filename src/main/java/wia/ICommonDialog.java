...
public interface ICommonDialog extends Com4jObject {
   ...
   * </p>
   * @param device Mandatory wia.IDevice parameter.
  ...
  @VTID(8)
  wia.IImageFile showAcquireImage(
    @Optional @DefaultValue("0") wia.WiaDeviceType deviceType,
    @Optional @DefaultValue("0") wia.WiaImageIntent intent,
    @Optional @DefaultValue("131072") wia.WiaImageBias bias,
   ...
   * @param alwaysSelectDevice Optional parameter. Default value is false
   * @param cancelError Optional parameter. Default value is false
   * @return  Returns a value of type wia.IDevice
   */

  @DISPID(3) //= 0x3. The runtime will prefer the VTID if present
  @VTID(9)
  wia.IDevice showSelectDevice(
    @Optional @DefaultValue("0") wia.WiaDeviceType deviceType,
    @Optional @DefaultValue("0") boolean alwaysSelectDevice,
    @Optional @DefaultValue("0") boolean cancelError);
   ...
   * </p>
   * @param item Mandatory wia.IItem parameter.
   * @param cancelError Optional parameter. Default value is false
   */
