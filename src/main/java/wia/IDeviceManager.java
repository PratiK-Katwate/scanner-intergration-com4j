...
public interface IDeviceManager extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type wia.IDeviceInfos
   */

  @DISPID(1) //= 0x1. The runtime will prefer the VTID if present
  @VTID(7)
  wia.IDeviceInfos deviceInfos();


  @VTID(7)
  @ReturnValue(defaultPropertyThrough={wia.IDeviceInfos.class})
  wia.IDeviceInfo deviceInfos(
